        ...
        <div class="max-w-2xl">
            <div class="rounded-xl bg-card shadow ring-1 ring-border">
                <div class="border-b border-border px-6 py-4">
                    <h2 class="text-base font-semibold text-foreground">Edit Job</h2>
                </div>
                <form @submit.prevent="submit" class="px-6 py-5">
                    ...
                    <div class="mt-6 flex items-center gap-3">
                        ...
                        <Link :href="`/owner/jobs/${job.id}`" class="text-sm text-muted-foreground hover:text-foreground">Cancel</Link>
                    </div>
                </form>
            </div>
        </div>
