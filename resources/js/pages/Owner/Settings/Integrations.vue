...
<template>
    <OwnerLayout title="Integrations">
        ...
        <div class="mb-6 flex items-center justify-between">
            <h2 class="text-xl font-semibold text-foreground">Integration Settings</h2>
        </div>
        ...
        <form @submit.prevent="submit">
            <div class="space-y-6">
                ...
                <div class="bg-card rounded-xl shadow p-6">
                    <h3 class="text-sm font-semibold text-foreground mb-4">Stripe</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs text-muted-foreground mb-1">Secret Key</label>
                            <input v-model="form.stripe_secret_key" type="text"
                                class="w-full border border-input bg-background rounded px-3 py-2 text-sm font-mono"
                                placeholder="sk_live_…" />
                        </div>
                        <div>
                            <label class="block text-xs text-muted-foreground mb-1">Publishable Key</label>
                            <input v-model="form.stripe_publishable_key" type="text"
                                class="w-full border border-input bg-background rounded px-3 py-2 text-sm font-mono"
                                placeholder="pk_live_…" />
                        </div>
                        <div class="sm:col-span-2">
                            <label class="block text-xs text-muted-foreground mb-1">Webhook Secret</label>
                ...
                <!-- Twilio -->
                <div class="bg-card rounded-xl shadow p-6">
                    <h3 class="text-sm font-semibold text-foreground mb-4">Twilio (SMS)</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs text-muted-foreground mb-1">Account SID</label>
                        ...
                        <div>
                            <label class="block text-xs text-muted-foreground mb-1">From Number</label>
                ...
                <!-- SendGrid -->
                <div class="bg-card rounded-xl shadow p-6">
                    <h3 class="text-sm font-semibold text-foreground mb-4">SendGrid (Email)</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                        ...
                        <div>
                            <label class="block text-xs text-muted-foreground mb-1">From Email</label>
                ...
                <!-- Google Maps -->
                <div class="bg-card rounded-xl shadow p-6">
                    <h3 class="text-sm font-semibold text-foreground mb-4">Google Maps</h3>
                    <div class="max-w-lg">
                        <label class="block text-xs text-muted-foreground mb-1">API Key</label>
