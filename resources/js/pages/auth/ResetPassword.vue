            ...
            <div class="w-full max-w-sm">
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div>
                        ...
                        />
                        <p v-if="form.errors.password_confirmation" id="password-confirmation-error" role="alert" class="mt-1.5 text-xs text-destructive">{{ form.errors.password_confirmation }}</p>
                    </div>
