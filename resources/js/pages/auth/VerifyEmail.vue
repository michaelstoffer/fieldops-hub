    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 flex flex-col items-center justify-center px-6 py-12 bg-background">
            ...
            <div class="w-full max-w-sm">
                ...
                <div v-if="verificationLinkSent" role="alert" class="mb-5 rounded-lg bg-green-50 border border-green-200 px-4 py-3 text-sm text-green-700 dark:bg-green-900/20 dark:border-green-800 dark:text-green-400">
